...
### Pré-requisitos
*[NotePad++](https://notepad-plus-plus.org/download/v7.6.6.html) - O editor de texto/código utilizando pelos autores. Fique a vontade para utilizar outras opções dispoíveis como o [Visual Studio Code](https://code.visualstudio.com/Download).
